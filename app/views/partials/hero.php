  ...
  <div class="container hero__inner">
    <div class="hero__content">
      ...
      <h1 class="hero__name">
        ...
        <span class="reveal-text" data-reveal data-reveal-delay="80"><span class="reveal-text__line">Sukmana.</span></span>
      </h1>
      ...
      <div class="hero__actions" data-reveal data-reveal-delay="280">
        <a href="<?= base_url('/#work') ?>" class="btn btn-primary magnetic" data-cursor="link">
